    ...
    <nav className="sticky top-0 z-50">
      <div className="lp-glass border-x-0 border-t-0">
        <div className="max-w-6xl mx-auto px-5 sm:px-6 h-16 flex items-center justify-between">
          ...
          <Link href="/today" className="lp-btn lp-btn-primary !px-4 !py-2 !text-[13.5px]">
            Launch app
            <ArrowRight size={15} />
          </Link>
        </div>
      ...
      <div className="relative max-w-6xl mx-auto px-5 sm:px-6 pt-16 sm:pt-24 pb-20">
        <div className="lp-hero-in max-w-3xl">
          ...
          <div className="mt-9 flex items-center gap-3 flex-wrap">
            <Link href="/today" className="lp-btn lp-btn-primary">
              Launch Life OS
              <ArrowRight size={17} />
            </Link>
        ...
        <div className="lp-card relative overflow-hidden text-center px-6 py-16 sm:py-20">
          ...
          <div className="relative">
            ...
            <div className="mt-9 flex items-center justify-center gap-3 flex-wrap">
              <Link href="/today" className="lp-btn lp-btn-primary !text-[16px] !px-7 !py-4">
                Launch Life OS
  ...
  return (
    <footer className="border-t" style={{ borderColor: "var(--lp-line)" }}>
      <div className="max-w-6xl mx-auto px-5 sm:px-6 py-10 flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <Link href="/today" className="text-[13.5px] inline-flex items-center gap-1.5 hover:text-white transition-colors" style={{ color: "var(--lp-muted)" }}>
